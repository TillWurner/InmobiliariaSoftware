...
@section('contenido')
    ...
    <div class="title2">
        <h1 class="lista">Documentos Inmueble</h1>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="#" method="POST">
                                {{-- <a href="{{ route('descargarDocumento', $documento->archivo) }}" class="btn btn-link" --}}
                                <a target="true"
    ...
    <div class="modal" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="container" method="POST" action="{{ route('registrarDocumento') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="descripcion" type="text" class="form-control" id="descripcion" maxlength="50"
                                required>
                        </div>
                        <div class="form-group">
